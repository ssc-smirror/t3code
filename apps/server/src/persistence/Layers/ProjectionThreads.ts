...
import { ModelSelection, ThreadBranchRename } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.branchRename != null ? JSON.stringify(row.branchRename) : null},
        ...
        DO UPDATE SET
          ...
          branch_rename_json = excluded.branch_rename_json,
