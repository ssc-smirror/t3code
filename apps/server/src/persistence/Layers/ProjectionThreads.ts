    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.branchRegenerationRequestId ?? null},
          ${row.branchRegenerationStartedAt ?? null},
        ...
        DO UPDATE SET
          ...
          branch_regeneration_request_id = excluded.branch_regeneration_request_id,
          branch_regeneration_started_at = excluded.branch_regeneration_started_at,
