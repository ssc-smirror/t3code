...
import Migration0041 from "./Migrations/041_ProjectionProjectsBranchNaming.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadBranchRegeneration.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionProjectsBranchNaming", Migration0041],
  [42, "ProjectionThreadBranchRegeneration", Migration0042],
] as const;
