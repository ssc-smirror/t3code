...
const ProjectionThreadDbRowSchema = ProjectionThread.mapFields(
  Struct.assign({
    ...
    branchRename: Schema.optional(Schema.NullOr(Schema.fromJsonString(ThreadBranchRename))),
  }),
);
    ...
    execute: () =>
      sql`
        SELECT
          ...
          branch_rename_json AS "branchRename",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                branchRename: row.branchRename ?? null,
                deletedAt: row.deletedAt,
            ...
            : repositoryIdentityResolver.resolve(option.value.workspaceRoot).pipe(
                Effect.map((repositoryIdentity) =>
                  Option.some({
                    ...
                    branchNaming: option.value.branchNaming ?? null,
                    autoGenerateBranchName: option.value.autoGenerateBranchName ?? null,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        branchRename: threadRow.value.branchRename ?? null,
