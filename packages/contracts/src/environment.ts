...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server understands regenerateBranch on thread.meta.update, the
      per-project branchNaming fields, and vcs.renameRef. Absent on older
      servers, so clients hide branch rename/regenerate UI. */
  threadBranchNaming: Schema.optionalKey(Schema.Boolean),
