...
import {
  ...
  type RegenerateThreadBranchInput,
  type RenameThreadBranchInput,
...
export type {
  ...
  RegenerateThreadBranchInput,
  RenameThreadBranchInput,
  SettleThreadInput,
  SnoozeThreadInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    renameBranch: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:rename-branch",
      execute: (input: RenameThreadBranchInput) => renameThreadBranch(input),
      scheduler,
      concurrency,
    }),
    regenerateBranch: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:regenerate-branch",
      execute: (input: RegenerateThreadBranchInput) => regenerateThreadBranch(input),
      scheduler,
      concurrency,
    }),
